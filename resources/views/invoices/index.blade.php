    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <a href="{{ route('invoices.create') }}" class="bg-blue-500 text-white bg-gray-800 px-4 py-2 rounded">
                    New Invoice
                </a>
                ...
                <table class="table-auto w-full mt-4 text-left border-collapse border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class=" px-4 py-2">
                            <a class="hover:underline" href="{{ route('invoices.create') }}">{{ $item->invoice_id }}</a>
                            </td>
                        ...
                        <div x-data="{ open: false }" class="relative inline-block text-left">
                            ...
                            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow-md z-10">
                                <a href="{{ route('invoices.edit', $item->id) }}" class="block px-4 py-2 text-sm hover:bg-gray-100">Edit</a>
                       ...
                       <!--     <td class=" px-4 py-2">
                                <a href="{{ route('invoices.show', $item->id) }}" class="text-blue-600  ">View</a>
                                <a href="{{ route('invoices.edit', $item->id) }}" class="text-yellow-600 ml-2">Edit</a>
                                <form action="{{ route('invoices.destroy', $item->id) }}" method="POST" class="inline-block">
                                    @csrf
                                    @method('DELETE')
