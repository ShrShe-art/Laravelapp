    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <a href="<?php echo e(route('invoices.create')); ?>" class="bg-blue-500 text-white bg-gray-800 px-4 py-2 rounded">
                    New Invoice
                </a>
                ...
                <table class="table-auto w-full mt-4 text-left border-collapse border border-gray-300">
                    <thead>
                        <tr class="bg-gray-100">
                            ...
                            <th class="border border-white-300 bg-blue-400 text-white  px-4 py-2">Status</th>
                            <th class="border border-white-300 bg-blue-400 text-white  px-4 py-2">Invoice Id</th>
                            <th class="border border-white-300 bg-blue-400 text-white  px-4 py-2">Client</th>
                            <th class="border border-white-300 bg-blue-400 text-white  px-4 py-2">Amount</th>
                            <th class="border border-white-300 bg-blue-400 text-white  px-4 py-2">Balance</th>
                            <th class="border border-white-300 bg-blue-400 text-white  px-4 py-2">Date</th>
                            <th class="border border-white-300 bg-blue-400 text-white  px-4 py-2">Due Date</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class=" px-4 py-2"><?php echo e($item->status); ?></td>
                            <td class=" px-4 py-2">
                            <a class="hover:underline" href="<?php echo e(route('invoices.create')); ?>"><?php echo e($item->invoice_id); ?></a>
                            </td>
                            <td class=" px-4 py-2"><?php echo e($item->client); ?></td>
                            <td class="  px-4 py-2">$<?php echo e($item->amount); ?></td>
                            <td class=" px-4 py-2"><?php echo e($item->balance); ?></td>
                            <td class=" px-4 py-2"><?php echo e($item->date); ?></td>
                            <td class="  px-4 py-2"><?php echo e($item->due_date); ?></td>
                        ...
                        <div x-data="{ open: false }" class="relative inline-block text-left">
                            ...
                            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow-md z-10">
                                <a href="<?php echo e(route('invoices.edit', $item->id)); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100">Edit</a>
                                <form method="POST" action="<?php echo e(route('invoices.destroy', $item->id)); ?>">
                                    <?php echo csrf_field(); ?>
                       ...
                       <!--     <td class=" px-4 py-2">
                                <a href="<?php echo e(route('invoices.show', $item->id)); ?>" class="text-blue-600  ">View</a>
                                <a href="<?php echo e(route('invoices.edit', $item->id)); ?>" class="text-yellow-600 ml-2">Edit</a>
                                <form action="<?php echo e(route('invoices.destroy', $item->id)); ?>" method="POST" class="inline-block">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
...
<?php endif; ?>		
				<!-- Modal -->
<div id="myModal" class="fixed inset-0 z-50 flex invoices-center justify-center bg-black bg-opacity-50 hidden">
...
<?php endif; ?>
``
<?php /**PATH C:\laravelapps\task-manager\resources\views/invoices/index.blade.php ENDPATH**/ ?>