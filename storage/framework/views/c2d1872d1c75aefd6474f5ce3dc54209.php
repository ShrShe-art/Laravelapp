    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <a href="<?php echo e(route('items.create')); ?>" class="bg-blue-500 text-white bg-gray-800 px-4 py-2 rounded">
                    Create Item
                </a>
                ...
                <table class="table-auto w-full mt-4 text-left border-collapse border border-gray-300">
                    <thead>
                        <tr class="bg-gray-100">
                            ...
                            <th class="border border-white-300 bg-blue-400 text-white  px-4 py-2">Name</th>
                            <th class="border border-white-300 bg-blue-400 text-white  px-4 py-2">Description</th>
                            <th class="border border-white-300 bg-blue-400 text-white  px-4 py-2">Price</th>
                            <th class="border border-white-300 bg-blue-400 text-white  px-4 py-2">Default Quantity</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class=" px-4 py-2"><?php echo e($item->description); ?></td>
                            <td class=" px-4 py-2"> $<?php echo e($item->price); ?></td>
                            <td class="  px-4 py-2"><?php echo e($item->default_quantity); ?></td>
                        ...
                        <div x-data="{ open: false }" class="relative inline-block text-left">
                            ...
                            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow-md z-10">
                                <a href="<?php echo e(route('items.edit', $item->id)); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100">Edit</a>
                       ...
                       <!--     <td class=" px-4 py-2">
                                <a href="<?php echo e(route('items.show', $item->id)); ?>" class="text-blue-600  ">View</a>
                                <a href="<?php echo e(route('items.edit', $item->id)); ?>" class="text-yellow-600 ml-2">Edit</a>
                                <form action="<?php echo e(route('items.destroy', $item->id)); ?>" method="POST" class="inline-block">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
...
<?php endif; ?>
``
<?php /**PATH C:\laravelapps\task-manager\resources\views/items/index.blade.php ENDPATH**/ ?>